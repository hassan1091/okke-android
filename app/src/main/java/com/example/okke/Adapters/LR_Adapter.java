...
public class LR_Adapter extends RecyclerView.Adapter<LR_Adapter.LR_viewHolder> {
    ...
    ArrayList<String> lastUserUrlArray;
    OnItemClickListener onItemClickListener;

    public LR_Adapter(ArrayList lastUserUrlArray, OnItemClickListener onItemClickListener) {
    ...
    public LR_viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        LR_viewHolder lr_viewHolder = new LR_viewHolder(view, onItemClickListener);
        return lr_viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull LR_viewHolder holder, int position) {
        holder.textView.setText(lastUserUrlArray.get(position));
    }
    ...
    static class LR_viewHolder extends RecyclerView.ViewHolder {
        ...
        public LR_viewHolder(@NonNull View itemView, final OnItemClickListener onItemClickListener) {
            super(itemView);
